...
public class SignUpController {
	...
	// Pour la validation avec les annotations sur les beans, il faut rajouter un
	// objet de type
	// BindingResult br JUSTE APRES le bean donc ici userForm car c'est lui qui
	// contient
	...
	public String load(Model model) {
		...
		for (int i = 0; i < 50; i++) {
			Member u = new Member(0, 0, "nom" + i, "email" + i, null, null, "password" + i, null, null, null, i, null,
	...
	public String createMember(@Valid @ModelAttribute("newBean") MemberForm memberForm, BindingResult br, Model model,
			Locale locale, HttpSession session) {

		Member u = new Member(0, 0, "vide", memberForm.getEmail(), null, null, memberForm.getPassword(), null, null,
